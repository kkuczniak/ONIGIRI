...
export default function Header() {
  return (
    <header className='min-h-[630px] relative pt-24 px-0 pb-20 mb-6 lg:text-left text-center'>
      <video
        loop
        autoPlay
      ...
      <div className='relative max-w-[1264px] lg:m-20'>
        <div className='flex text-white flex-col lg:w-2/5 m-3'>
          <h1 className='text-5xl tracking-wide  leading-tight'>
            Kosmetyki idealne na wiosenne promienie słońca
          </h1>
          <h3 className='text-xl pt-5 tracking-wide leading-snug '>
            Sprawdź nowości stworzone dla pielęgnacji skóry by powitać wiosenną
            pogodę bez żadnych zmartwień!
          </h3>
          <Link href='/allProducts'>
            <a className='mx-auto mt-14 p-2 tracking-wider uppercase border rounded w-auto text-center bg-[#ffffff23]'>
              Nowości
            </a>
          </Link>
        </div>
